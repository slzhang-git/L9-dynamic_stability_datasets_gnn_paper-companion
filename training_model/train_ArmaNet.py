...
plt.plot(test_R2_all_epochs, label="test")
plt.plot(train_R2_all_epochs, label="train")
plt.ylabel('$R^2$')
plt.xlabel('epochs')
plt.legend()
plt.show()

plt.plot(test_accu_all_epochs, label="test")
plt.plot(train_accu_all_epochs, label="train")
plt.ylabel('Accuracy')
plt.xlabel('epochs')
plt.legend()
plt.show()
